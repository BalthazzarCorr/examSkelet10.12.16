(function (factory) {
  ...
  // `Sammy.EJS` is a thin wrapper around the EJS template engine which can be donwloaded
  // at http://embeddedjs.com/
  //
  // Note: As of Sammy 0.7, Sammy.EJS does not include the actual template engine in the source.
  // Include ejs.js before including sammy.ejs.js
  Sammy.EJS = function(app, method_alias) {

    // *Helper:* Uses simple template to parse ERB like templates.
    //
    // ### Arguments
    //
